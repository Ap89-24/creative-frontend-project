...
const WorkCard = ({image1, image2}) => {
  return (
         ...
         <>
          <div className="lg:w-1/2 h-full group overflow-hidden relative hover:rounded-[30px]">
          ...
          <div className="lg:w-1/2 h-full relative group overflow-hidden hover:rounded-[30px] transition-all">
