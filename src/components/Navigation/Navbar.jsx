...
import {NavBarContext, NavBarSvgContext} from "../../context/NavBarContext";
...
const Navbar = () => {
  ...
  const [svgColor, setsvgColor] = useContext(NavBarSvgContext)
  ...
  return (
    <div className="z-4 flex fixed top-0 w-full items-start justify-between">
      ...
      onMouseEnter={()=>{
        ...
        navIRef.current.style.color = 'black'
      }}
      onMouseLeave={()=>{
