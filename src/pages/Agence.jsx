...
<div className='parent'>
  ...
  <div id='page1' className='py-5'>
    <div ref={imageDivRef} className=' lg:h-[20vw] h-[35vw] w-54 lg:rounded-3xl rounded-xl absolute lg:top-50 top-80 lg:left-107 left-30'>
      ...
      <div className='lg:mt-[30vw] mt-[20vh]'>
        <h1 className='lg:text-[20vw] text-[18vw] leading-[16vw] text-center'>SEVEN7Y <br />
         TWO</h1>
      </div>

      <div className='lg:pl-[42%] mt-9 p-12'>
        <p className='lg:text-5xl text-4xl'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We’re inquisitive and open-minded, and we make sure creativity crowds out ego from every corner. A brand is a living thing, with values, a personality and a story. If we ignore that, we can achieve short-term success, but not influence that goes the distance. We bring that perspective to every brand story we help tell.</p>
      </div>
    </div>
</div>
